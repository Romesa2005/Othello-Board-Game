...
public class Othello {
	...
	public boolean move(int row, int col) {
		char turn = getWhosTurn();
		boolean x = board.move(row, col,turn);
		if (board.hasMove()==OthelloBoard.EMPTY){
			this.whosTurn= OthelloBoard.EMPTY;
		}
		else if (whosTurn == OthelloBoard.P1 && (board.hasMove()==OthelloBoard.P2 || board.hasMove()==OthelloBoard.BOTH)){
				this.whosTurn= OthelloBoard.P2;}
		else if (whosTurn == OthelloBoard.P2 && (board.hasMove()==OthelloBoard.P1 || board.hasMove()==OthelloBoard.BOTH)){
